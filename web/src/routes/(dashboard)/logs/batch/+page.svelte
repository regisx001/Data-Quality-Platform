...
<svelte:head>
	...
	<meta name="description" content="View batch operational metrics, severity distributions, latency percentiles, and traffic analytics." />
</svelte:head>
