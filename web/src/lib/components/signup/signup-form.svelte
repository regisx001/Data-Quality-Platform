...
<div class={cn("grid h-full w-full md:grid-cols-2 lg:grid-cols-[1fr_1.1fr] bg-background overflow-hidden", className)} {...restProps}>
	<!-- Left Side: Appwrite Style Full-Height Auth Panel -->
	<div class="flex flex-col justify-between h-full p-6 sm:p-10 md:p-12 lg:p-16 overflow-y-auto">
		<!-- Top: Brand Logo -->
				...
				<Field.Group class="gap-5">
					...
					<Field.Field class="grid grid-cols-1 sm:grid-cols-2 gap-4">
						...
						<Field.Field>
							...
							<Input id="confirm-password" type="password" bind:value={confirmPassword} required class="h-10 rounded-xl" />
						</Field.Field>
					</Field.Field>
					...
					<Field.Field class="grid grid-cols-3 gap-3">
						...
						<Button variant="outline" type="button" class="cursor-pointer">
							<svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
								<path
	...
	<!-- Right Side: Appwrite / Vercel Style Architectural Artwork Panel -->
