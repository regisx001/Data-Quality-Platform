<script lang="ts">
	...
	let {
		...
		class: className,
		...restProps
	}: HTMLAttributes<HTMLDivElement> & { form?: { error?: string; login?: string } | null } = $props();
...
<div class={cn("grid h-full w-full md:grid-cols-2 lg:grid-cols-[1.1fr_1fr] bg-background overflow-hidden relative", className)} {...restProps}>
